...
groq_api_key_PATH = os.path.expandvars(
    os.path.expanduser(
        os.getenv(
            "groq_api_key_PATH",
...
HF_STORED_TOKENS_PATH = os.path.join(os.path.dirname(groq_api_key_PATH), "stored_tokens")
...
if _staging_mode:
    ...
    groq_api_key_PATH = os.path.join(_staging_home, "token")

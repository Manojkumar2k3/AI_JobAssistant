...
@repos_cli.command(
    ...
    examples=[
        ...
        "hf repos create my-space --type space --space-sdk gradio --flavor t4-medium --secrets groq_api_key -e THEME=dark --protected",
...
@repos_cli.command(
    ...
    examples=[
        ...
        "hf repos duplicate multimodalart/dreambooth-training my-dreambooth --type space --flavor l4x4 --secrets groq_api_key --private",
